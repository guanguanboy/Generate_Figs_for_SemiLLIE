...
def save_images(image_floder_name, image_full_name, image_name,location1=[],location2=[]):
    ...
    # 打开图片
    origin_img_path = os.path.join('images', image_floder_name, image_full_name)
...
"""
image_floder_name = 'LSRW2045_Resized' #2045, LSRW2045_Resized
...
for image_name in file_names:
    ...
    save_images(image_floder_name, image_name, image_name[:-4], location1 = [35,85], location2=[615,185])
